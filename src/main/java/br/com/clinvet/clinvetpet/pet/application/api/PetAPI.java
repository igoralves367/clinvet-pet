...
public interface PetAPI {
    ...
    List<PetListResponse> getPetsDoClienteComId(@PathVariable UUID idCliente);
	...
	void deletePetClienteComId(@PathVariable UUID idCliente, @PathVariable UUID idPet);
    
    @PatchMapping(value = "/{idPet}")
	@ResponseStatus(code = HttpStatus.NO_CONTENT)
	void patchtPet(@PathVariable UUID idCliente, @PathVariable UUID idPet,
